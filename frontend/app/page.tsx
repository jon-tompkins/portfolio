...
const projects = [
  {
    ...
    description: 'Curated intelligence dispatches from the voices you actually trust — Twitter, newsletters, YouTube — synthesized by AI into reads worth your time.',
  ...
  },
  {
    ...
    description: 'AI equity research platform built on a multi-agent investment process. Specialized agents handle screening, fundamental analysis, and technical analysis — synthesized into actionable trade ideas.',
  ...
  {
    name: 'Rattools',
    tagline: 'Tools & dashboards for the RATSPEAK ecosystem',
    description: 'Operator tooling, token utilities, and on-chain helpers for RATSPEAK liquidity, signals, and distribution mechanics.',
    tech: ['Next.js', 'Solidity', 'Base'],
    icon: Zap,
    status: 'active',
    url: 'https://www.rattools.xyz',
    highlights: ['RATSPEAK token utilities', 'Liquidity & signals tooling', 'Operator dashboards'],
  },
  {
    name: 'Screeners',
    tagline: 'Trading screeners & signal pipelines',
    description: 'Autonomous screeners that surface high-conviction setups across on-chain and macro data. Built for speed and low noise.',
    tech: ['Python', 'xAI', 'Cron', 'Data pipelines'],
    icon: BarChart3,
    status: 'active',
    url: '',
    highlights: ['Ground-up style instability + opportunity screeners', 'Autonomous refresh loops', 'Low-noise, high-signal output'],
  },
  {
    name: 'Aegis',
  ...
  },
  {
    ...
    description: 'Ad marketplace where publishers set their own price and own their slots permanently. No auctions, no intermediaries taking 45%, no uncertainty.',
  ...
  },
  {
    ...
    description: 'AI agents compete for real stakes with verifiable track records and provable skill. Features trading competitions and on-chain Rock Paper Scissors with commit-reveal fairness.',
...
const experimental = [
  {
    ...
    description: 'An AI agent that independently analyzes markets, generates trade ideas, executes paper trades, and learns from its results on a daily schedule.',
...
export default function Home() {
  return (
    <div className="min-h-screen bg-zinc-950">
      ...
      <section className="pt-24 pb-10 px-6">
        <div className="mx-auto max-w-6xl">
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl text-white">
            ...
            <span className="text-zinc-300">AI, Trading, and DeFi.</span>
          </h1>
          <div className="mt-6 flex gap-4">
            <a href="https://github.com/jon-tompkins" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 text-sm text-zinc-300 hover:text-white transition-colors">
            ...
            <a href="https://twitter.com/jonto21" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 text-sm text-zinc-300 hover:text-white transition-colors">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.741l7.73-8.835L1.254 2.25H8.08l4.259 5.63zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg> Twitter
            </a>
            <a href="https://www.linkedin.com/in/thejonathantompkins/" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 text-sm text-zinc-300 hover:text-white transition-colors">
            ...
            <a href="mailto:Jon.tomp@gmail.com" className="inline-flex items-center gap-2 text-sm text-zinc-300 hover:text-white transition-colors">
      ...
      {/* Projects */}
      <section id="projects" className="py-10 border-t border-zinc-800/50">
