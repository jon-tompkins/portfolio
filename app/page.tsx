      ...
      <section className="pt-32 pb-20 px-6">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-8 flex gap-6">
            ...
            <a href="https://www.linkedin.com/in/thejonathantompkins/" target="_blank" className="inline-flex items-center gap-2 text-sm text-zinc-400 hover:text-white transition-colors">
