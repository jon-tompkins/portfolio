      ...
      <section className="pt-32 pb-20 px-6">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-8 flex gap-4">
            <a href="https://github.com/jon-tompkins" target="blank" className="inline-flex items-center gap-2 text-sm text-zinc-400 hover:text-zinc-100 transition-colors">
